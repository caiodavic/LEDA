...
public class StudentQueueTest {
	...
	private void getImplementations() {
		...
		queueTam0 = new QueueUsingStack<>(0);
	}
	...
	@Test
	public void testaInsereNull()throws QueueOverflowException{
		queue3.enqueue(null);
		assertTrue(queue3.isEmpty());
	...
	@Test
	public void insereERemoveMuitosElementos() throws QueueOverflowException, QueueUnderflowException{
	...
	@Test
	public void testandoQueueTam0() throws QueueOverflowException, QueueUnderflowException {
